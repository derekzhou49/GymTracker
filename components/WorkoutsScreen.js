        ...
        <FlatList
          ...
          renderItem = {itemData => (
              ...
              leftContent={
		        ...
		        >
              <TouchableOpacity activeOpacity={.8} onPress={() => props.navigation.navigate("StartWorkout", {screen: "StartWorkout", params: {workoutName: itemData.item.value, workoutID: itemData.item.workoutId}})}>
